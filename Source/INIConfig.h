...
namespace LayoutConstants {
   ...
   constexpr int loopSectionLabelWidth = static_cast<int>(Defaults::DEFAULT_INTERFACE_WIDTH * 0.1f);
   constexpr int loopSectionLabelHeight = static_cast<int>(Defaults::DEFAULT_INTERFACE_HEIGHT * 0.0313f);
   constexpr int loopSectionLabelMargin = static_cast<int>(Defaults::DEFAULT_INTERFACE_WIDTH * 0.0092f);
   constexpr int loopSectionSliderHeight = static_cast<int>(Defaults::DEFAULT_INTERFACE_HEIGHT * 0.05f);
   constexpr int loopSectionSliderMargin = defaultMargin;
   constexpr int loopSectionSliderY = static_cast<int>(Defaults::DEFAULT_INTERFACE_HEIGHT * 0.0313f);
   constexpr int loopSectionSliderWidthReduction = static_cast<int>(Defaults::DEFAULT_INTERFACE_WIDTH * 0.0333f);
